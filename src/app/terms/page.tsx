    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between selection:bg-indigo-500 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 sm:px-8 flex-1 w-full space-y-8">
        ...
        <section className="space-y-4 text-slate-300 text-sm leading-relaxed">
          <h2 className="text-xl font-bold text-slate-100 tracking-tight">1. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-4 text-slate-300 text-sm leading-relaxed">
          <h2 className="text-xl font-bold text-slate-100 tracking-tight">2. Academic Integrity & Acceptable Uploads</h2>
          <p>
        ...
        <section className="space-y-4 text-slate-300 text-sm leading-relaxed">
          <h2 className="text-xl font-bold text-slate-100 tracking-tight">3. User Content & Ownership</h2>
          <p>
        ...
        <section className="space-y-4 text-slate-300 text-sm leading-relaxed">
          <h2 className="text-xl font-bold text-slate-100 tracking-tight">4. Admin Rights & Content Moderation</h2>
          <p>
        ...
        <section className="space-y-4 text-slate-300 text-sm leading-relaxed border-t border-slate-800 pt-6">
          <h2 className="text-xl font-bold text-slate-100 tracking-tight">5. Developer Attribution</h2>
          <p>
